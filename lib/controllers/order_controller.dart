...
class OrderController extends GetxController implements GetxService {
  ...
  Future<void> getOrderList() async {
    ...
    _isLoading = false;
    print("the length  of orders " + _currentOrderList.length.toString());
    print("the length  of orders " + _historyOrderList.length.toString());
